#!/bin/bash
#SBATCH --job-name=ipttt_qwen3_swa8k_ct64k
#SBATCH --account=pli
...
#SBATCH --output=logs/ipttt_qwen3_swa8k_ct64k_%j.out
#SBATCH --error=logs/ipttt_qwen3_swa8k_ct64k_%j.err

# Qwen3-0.6B IPTTT baseline: SWA window=8192, ttt_chunk=4096, 4 TTT layers,
# 64K context, 10K steps. Recipe matches v2 IPTTCDv9 SWA-8k for direct
# comparison of IPTTT (closed-form Hebbian/FWP) vs IPTTCDv9 (in-place context
# distillation) under identical attention scope and CT budget.
...
export CONFIG_PATH="configs/ipttt/ipttt_qwen3_0.6B_64k_swa8k_ct.json"
export TOKENIZER_PATH="tokenizers/Qwen3-0.6B-Base"
export EXP_DIR="exp/ipttt_qwen3_0.6B_64k_swa8k_ct/run"
export DCP_INIT="exp/ipttt_qwen3_0.6B_64k_swa8k_ct/checkpoint/step-0"
