#!/bin/bash
#SBATCH --job-name=ipttcdv9_smol_ct64k_v2_swa8k
#SBATCH --account=pli
...
#SBATCH --output=logs/ipttcdv9_smol_ct64k_v2_swa8k_%j.out
#SBATCH --error=logs/ipttcdv9_smol_ct64k_v2_swa8k_%j.err

# SmolLM2-360M IPTTCDv9 v2 (init massage) SWA-8192 CT.
# Recipe matches Qwen3 v2 SWA-8k for cross-family comparison.
...
export CONFIG_PATH="configs/ipttcd/ipttcdv9_smollm2_360M_ct_64k_v2_swa8k.json"
export TOKENIZER_PATH="tokenizers/SmolLM2-360M"
export EXP_DIR="exp/ipttcdv9_smollm2_360M_ct_64k_v2_swa8k/run"
export DCP_INIT="exp/ipttcdv9_smollm2_360M_ct_64k_v2_swa8k/checkpoint/step-0"
