#!/bin/bash
#SBATCH --job-name=ipttt_smol_swa8k_ct64k
#SBATCH --account=pli
...
#SBATCH --output=logs/ipttt_smol_swa8k_ct64k_%j.out
#SBATCH --error=logs/ipttt_smol_swa8k_ct64k_%j.err

# SmolLM2-360M IPTTT (SWA-8192) baseline. Mirror of Qwen3 IPTTT SWA-8K
# for cross-family comparison vs SmolLM2 IPTTCDv9 v2 SWA-8k.
...
export CONFIG_PATH="configs/ipttt/ipttt_smollm2_360M_64k_swa8k_ct.json"
export TOKENIZER_PATH="tokenizers/SmolLM2-360M"
export EXP_DIR="exp/ipttt_smollm2_360M_64k_swa8k_ct/run"
export DCP_INIT="exp/ipttt_smollm2_360M_64k_swa8k_ct/checkpoint/step-0"
